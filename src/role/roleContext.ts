...
class Memory {
  // Define Memory properties and methods here
}

interface Action {
  // Define Action properties and methods here
}

interface Message {
  // Define Message properties and methods here
}
...
class RoleContext {
  ...
  todo?: Action; // 下一個待執行的Action。當state>=0時，會指向下一個Action
